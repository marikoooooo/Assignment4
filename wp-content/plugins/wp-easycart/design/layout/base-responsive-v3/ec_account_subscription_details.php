...
<?php if( !$this->subscription->is_canceled( ) ){ ?>
	<div class="ec_account_subscription_row"><b><?php echo wp_easycart_language( )->get_text( 'account_subscriptions', 'subscription_details_next_billing' ); ?>:</b> <?php $this->subscription->display_next_bill_date( ); ?></div>
<?php }?>
