...
<?php wp_easycart_admin_verification( )->print_nonce_field( 'wp_easycart_nonce', 'wp-easycart-manufacturer-details' ); ?>
<input type="hidden" name="ec_admin_form_action" value="<?php echo esc_attr( $this->form_action ); ?>" />
<input type="hidden" name="manufacturer_id" value="<?php echo esc_attr( $this->id ); ?>" />
        ...
        <div class="ec_admin_flex_row">
            <div class="ec_admin_list_line_item ec_admin_col_12 ec_admin_col_first">
            	<div class="ec_admin_settings_label">
                    ...
                    <span><?php if( isset( $_GET['ec_admin_form_action'] ) && $_GET['ec_admin_form_action'] == 'add-new' ){ esc_attr_e( 'ADD NEW MANUFACTURER', 'wp-easycart' ); }else{ esc_attr_e('EDIT MANUFACTURER', 'wp-easycart' ); } ?></span>
                    <div class="ec_page_title_button_wrap">
                        ...
                        <?php wp_easycart_admin( )->helpsystem->print_vids_url('products', 'manufacturers', 'details');?>
                        ...
                        <a href="post.php?post=<?php echo esc_attr( $this->manufacturer->post_id ); ?>&action=edit" target="_blank" class="ec_page_title_button"><?php esc_attr_e( 'Edit Yoast SEO', 'wp-easycart' ); ?></a>
                        <?php } ?>
