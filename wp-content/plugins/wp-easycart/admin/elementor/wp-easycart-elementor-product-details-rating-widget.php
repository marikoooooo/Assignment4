<?php
/**
 * WP EasyCart Product Details Rating Widget Display for Elementor
 *
...
$args = shortcode_atts(
	array(
		'shortcode' => 'product_details_rating',
		'use_post_id' => false,
		'product_id' => '',
	),
	$atts
...
echo '<div class="wp-easycart-product-details-rating-shortcode-wrapper d-flex">';
echo do_shortcode( '[ec_product_details_rating ' . $extra_atts . ']' );
echo '</div>';
