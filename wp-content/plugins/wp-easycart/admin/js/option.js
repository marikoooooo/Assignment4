...
function ec_admin_option_type_change(field) {
	if ( document.getElementById( 'option_type').value == 'upgrade_required' ) {
		...
		jQuery( document.getElementById( 'ec_admin_row_option_meta_min_length' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_meta_max_length' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_error_text' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_required' ) ).hide( );
	...
	} else if ( document.getElementById( 'option_type').value == 'text' ) {
		jQuery( document.getElementById( 'ec_admin_row_option_meta_min' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_meta_max' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_meta_step' ) ).hide( );
		jQuery( document.getElementById( 'ec_admin_row_option_meta_min_length' ) ).show( );
		jQuery( document.getElementById( 'ec_admin_row_option_meta_max_length' ) ).show( );
		jQuery( document.getElementById( 'ec_admin_row_option_error_text' ) ).show( );
		jQuery( document.getElementById( 'ec_admin_row_option_required' ) ).show( );
...
function wpeasycart_optionitem_update_override_file( element ) {
	if ( jQuery( '#is_override_file' ).is( ':checked' ) ) {
		jQuery( '#ec_admin_row_is_override_amazon' ).show();
		if ( '1' == jQuery( '#is_override_amazon' ).val() ) {
			jQuery( '#ec_admin_row_override_amazon_key' ).show();
			jQuery( '#ec_admin_row_override_file_name' ).hide();
		} else {
			jQuery( '#ec_admin_row_override_amazon_key' ).hide();
			jQuery( '#ec_admin_row_override_file_name' ).show();
		}
	} else {
		jQuery( '#ec_admin_row_is_override_amazon' ).hide();
		jQuery( '#ec_admin_row_override_amazon_key' ).hide();
		jQuery( '#ec_admin_row_override_file_name' ).hide();
	}
}

function wpeasycart_optionitem_update_additional_file( element ) {
	if ( jQuery( '#is_additional_file' ).is( ':checked' ) ) {
		jQuery( '#ec_admin_row_is_additional_amazon' ).show();
		if ( '1' == jQuery( '#is_additional_amazon' ).val() ) {
			jQuery( '#ec_admin_row_additional_amazon_key' ).show();
			jQuery( '#ec_admin_row_additional_file_name' ).hide();
		} else {
			jQuery( '#ec_admin_row_additional_amazon_key' ).hide();
			jQuery( '#ec_admin_row_additional_file_name' ).show();
		}
	} else {
		jQuery( '#ec_admin_row_is_additional_amazon' ).hide();
		jQuery( '#ec_admin_row_additional_amazon_key' ).hide();
		jQuery( '#ec_admin_row_additional_file_name' ).hide();
	}
}
